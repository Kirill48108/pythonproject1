...
from main import filter_by_keyword, filter_transactions, load_csv, load_json, load_xlsx, sort_transactions
...
def test_load_xlsx(mock_read_excel):
    mock_read_excel.return_value = pd.DataFrame({"description": ["Sample transaction"], "status": ["EXECUTED"]})
