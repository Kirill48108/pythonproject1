...
print(convert_transaction(transaction_usd))  # Сумма в рублях конвертированная из USD
print(convert_transaction(transaction_eur))  # Сумма в рублях конвертированная из EUR
print(convert_transaction(transaction_rub))  # Сумма в рублях

from utils import get_info_about_transactions

file_path = "data/operations.json"

transactions = get_info_about_transactions(file_path)
print(transactions)
